...
*}
    ...
    <script  type="text/javascript" src="plugins/GeoIPMap/javascripts/osm.js"></script>
...
<body>
    ...
    <div id="selector" style="font-size: smaller;" >
        ...
        <input type="radio" id="radio5" name="chooser" value="amc"/><label for="radio5">Central America</label>
